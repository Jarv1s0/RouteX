...
if (publicKeyLines.length < 2 || !/comment/i.test(publicKeyLines[0])) {
  console.error(
    '[release-env] ROUTEX_UPDATER_PUBLIC_KEY must be the full public key file generated by `tauri signer generate`, including its comment line'
  )
  process.exit(1)
}
