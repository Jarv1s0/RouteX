              ...
              <div className="divide-y divide-default-200/40 dark:divide-white/5">
                {[
                  ...
                  .map(({ label, value }) => (
                    ...
                    >
                      <span className="text-xs text-default-400 font-medium w-24 shrink-0">
                        {label}
                      </span>
                      <span
            ...
            <ScrollShadow className="flex-1 -mr-4 pr-4 relative z-10 pb-4">
              <div className="flex flex-col gap-0">
                ...
                {chainGroups.map((item, index) => {
                  ...
                  return (
                    <TimelineNode
                      ...
                      subtitle={
                        group?.now
                          ? t('connections.detail.current', { value: group.now })
                          : undefined
                      }
                      delay={delay}
                ...
                <TimelineNode
                  type="destination"
                  title={
                    connection.metadata.host || connection.metadata.destinationIP || destination
                  }
                  subtitle={
