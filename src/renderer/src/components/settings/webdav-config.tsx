...
import { listWebdavBackups, webdavBackup } from '@renderer/utils/webdav-ipc'
...
const WebdavConfig: React.FC = () => {
  ...
  const { webdavUrl, webdavUsername, webdavPassword, webdavDir = 'routex' } = appConfig || {}
  ...
  return (
    <>
      ...
      <SettingCard title="WebDAV 备份" collapsible>
