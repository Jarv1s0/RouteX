...
pub(crate) const APP_BIN_DIR_NAME: &str = "bin";
pub(crate) const APP_RUNTIME_LOGS_DIR_NAME: &str = "logs";
pub(crate) const LEGACY_APP_CORE_DIR_NAME: &str = "core";
pub(crate) const LEGACY_APP_RUNTIME_TASKS_DIR_NAME: &str = "tasks";
pub(crate) const LEGACY_APP_RUNTIME_TOOLS_DIR_NAME: &str = "tools";
#[cfg(target_os = "windows")]
pub(crate) const WINDOWS_APP_DATA_DIR_NAME: &str = "routex";
#[cfg(target_os = "windows")]
pub(crate) const LEGACY_WINDOWS_APP_DATA_DIR_NAME: &str = "routex.app";
#[cfg(target_os = "windows")]
